...
_PRD_LED_Toggel = PRD_LED_Toggel;
...
_PRD_swi = PRD_swi;
_KNL_swi = KNL_swi;
_SWI_process_ping = SWI_process_ping;
_SWI_process_pong = SWI_process_pong;
_TSK_idle = TSK_idle;
_led_toggle_tsk = led_toggle_tsk;
...
MEMORY {
   ...
   IRAM        : origin = 0x0,         len = 0x3f000
   MyBuffers   : origin = 0x3f000,     len = 0x1000
}
/* MODULE CLK */
SECTIONS {
   .clk: {
